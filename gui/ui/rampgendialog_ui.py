...
#
# Created: Wed May 30 13:02:23 2018
...
class Ui_RampGenDialog(object):
    def setupUi(self, RampGenDialog):
        ...
        self.gridLayout.addWidget(self.tfinalFormLabel, 10, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.tfinalLabel, 10, 2, 1, 2)
...
"")
        ...
        self.gridLayout.addWidget(self.writeOutPushButton, 12, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.npointsLabel, 8, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.npointsFormLabel, 8, 0, 1, 2)
        ...
        self.tdecompressLabel = QtGui.QLabel(self.formWidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tdecompressLabel.sizePolicy().hasHeightForWidth())
        self.tdecompressLabel.setSizePolicy(sizePolicy)
        self.tdecompressLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.tdecompressLabel.setIndent(10)
        self.tdecompressLabel.setObjectName("tdecompressLabel")
        self.gridLayout.addWidget(self.tdecompressLabel, 7, 0, 1, 2)
        self.tdecompressDoubleSpinBox = QtGui.QDoubleSpinBox(self.formWidget)
        self.tdecompressDoubleSpinBox.setMaximum(99999.99)
        self.tdecompressDoubleSpinBox.setObjectName("tdecompressDoubleSpinBox")
        self.gridLayout.addWidget(self.tdecompressDoubleSpinBox, 7, 2, 1, 2)
    ...
    def retranslateUi(self, RampGenDialog):
        ...
        self.tfinalFormLabel.setText(QtGui.QApplication.translate("RampGenDialog", "t relative after decompress", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.fcutDoubleSpinBox.setSuffix(QtGui.QApplication.translate("RampGenDialog", " MHz", None, QtGui.QApplication.UnicodeUTF8))
        self.tdecompressLabel.setText(QtGui.QApplication.translate("RampGenDialog", "t decompress", None, QtGui.QApplication.UnicodeUTF8))
        self.tdecompressDoubleSpinBox.setSuffix(QtGui.QApplication.translate("RampGenDialog", " ms", None, QtGui.QApplication.UnicodeUTF8))
